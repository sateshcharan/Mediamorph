export default function About() {
  return (
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8 w-3/4 mx-auto">
      <p>
        Introducing MediaMorph, the ultimate multimedia conversion powerhouse
      ...
      <div className="space-y-2">
        ...
        <p>
          Access MediaMorph from any device with an internet connection. Whether
      ...
      <div className="space-y-2">
        <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">
          🌟 It's Free, It's Powerful, It's MediaMorph:
        </h2>
        <p>
