export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8 w-3/4 mx-auto">
      <p>Effective Date: Wed 15 Sep 2024</p>
      <p>
        At MediaMorph, we are committed to safeguarding your privacy. This Privacy
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          <span className="text-orange-500">
            <a href="mailto:sateshcharans@gmail">sateshcharans@gmail.com</a>
          </span>
        </p>
      </div>

      <p>
        By using MediaMorph, you agree to the practices outlined in this Privacy
